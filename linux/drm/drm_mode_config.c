...
void drm_mode_config_reset(struct drm_device *dev)
{
	...
	drm_for_each_crtc(crtc, dev)
		if (crtc->funcs->reset)  //执行vs_crtc_reset函数，该函数在vs_crtc.c 完成func的转换
...
void drm_mode_config_init(struct drm_device *dev)
{
	...
	INIT_LIST_HEAD(&dev->mode_config.crtc_list);  //初始化listhead
	...
	drm_mode_create_standard_properties(dev);  //创建标准property
